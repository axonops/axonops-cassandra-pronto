...
echo "auto_start_cassandra = ${auto_start_cassandra}" > /var/log/bootstrap_cassandra.log 2>&1

chmod +x /opt/cassandra/scripts
/opt/cassandra/scripts/bootstrap.sh ${auto_start_cassandra} >> /var/log/bootstrap_cassandra.log 2>&1
